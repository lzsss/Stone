...
public class Parser {
    ...
    /**
     * Method Chaining
     * Usually used in many parameters but specify a few.
     * Eg: pig.color(black).size(large).age(2)
     * @return
     */
    public Parser reset() {
    ...
    /**
     * Add identifiers in rule except for reserved words.
     * @param reserved
     * @return
     */
    ...
    /**
     * Add pat in rule. 3 dots means zero or more parameters.
     * @param pat
     * @return
     */
    ...
    /**
     * Not in the ASTree. Usual for punctuation.
     * @param pat
     * @return
     */
    ...
    /**
     * The relationship between ps is or. Non-terminator
     * @param p
     * @return
     */
    ...
    /**
     * Non-terminator could be or not be.
     * @param p
     * @return
     */
    ...
    /**
     * Non-terminator. The difference between option() and repeat() is max time
     * of p in option() is 1, but more times for repeat()
     * @param p
     * @return
     */
    ...
    /**
     * Insert new branch at the or-tree at start of rule.
     * @param p
     * @return
     */
